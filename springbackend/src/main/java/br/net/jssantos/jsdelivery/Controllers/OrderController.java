...
import br.net.jssantos.jsdelivery.services.OrderService;
...
public class OrderController {
	...
	public ResponseEntity<OrderDto> update(@PathVariable Long id){
		OrderDto dto = service.update(id, OrderStatus.DELIVERED);
		return ResponseEntity.ok().body(dto);
	}
	
	@PutMapping("/{id}/canceled")
	public ResponseEntity<OrderDto> cancel(@PathVariable Long id){
		OrderDto dto = service.update(id, OrderStatus.CANCELED);
		return ResponseEntity.ok().body(dto);
	}		
}
